...
| 8 | Использовать платформы Java, .NET, PHP                                |
| 9 | Горизонтальное масштабирование на 2 ЦОД                               |
| 10 | Использовать Kafka для очередей сообщений                            |
| 11 | Не дорабатывать функционал подрядчика в интернет-банке               |
| 12 | Следует избегать прямого обмена данными между онлайн-банком и АБС    |
